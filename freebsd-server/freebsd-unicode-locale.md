...
Assuming you [fetched this homelab documentation](freebsd-command-line-tools.md#fetch-configuration-files) in `/homelab-documentation`, you may apply those changes with just a few commands.

```console
# cd /etc
# patch --posix -p1 -i /homelab-documentation/freebsd-server/unicode-locale/patches/login-use-unicode-locale.diff
