...
### FreeBSD Server
 ...
 13. [Storage health monitoring with `smartd` on FreeBSD](freebsd-server/freebsd-storage-health-monitoring-smart.md)
 14. [Configuring firewall for FreeBSD with `pf`](freebsd-server/freebsd-firewall.md)
 15. [Authoritative DNS server on FreeBSD with BIND](freebsd-server/freebsd-dns-bind.md)
 16. [Faster DNS zone replication on FreeBSD with `nsnotifyd`](freebsd-server/freebsd-faster-dns-replication-nsnotifyd.md)
